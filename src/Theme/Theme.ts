...
export function mapTheme(theme: Theme): MappedTheme {
    return {
        '--color-primary': theme.colors.primary || defaultTheme.colors.primary || '',
        '--color-background': theme.colors.background || defaultTheme.colors.background || '',
        '--color-foreground': theme.colors.foreground || defaultTheme.colors.foreground || '',
        '--color-gray': theme.colors.gray || defaultTheme.colors.gray || '',
        '--color-subtext': theme.colors.subtext || defaultTheme.colors.subtext || '',
        '--color-border': theme.colors.border || defaultTheme.colors.border || '',
        '--color-danger': theme.colors.danger || defaultTheme.colors.danger || '',
        '--color-success': theme.colors.success || defaultTheme.colors.success || '',
        '--color-warning': theme.colors.warning || defaultTheme.colors.warning || ''
    }
}